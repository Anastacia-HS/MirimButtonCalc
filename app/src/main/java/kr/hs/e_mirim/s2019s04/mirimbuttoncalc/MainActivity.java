package kr.hs.e_mirim.s2019s04.mirimbuttoncalc;
...
public class MainActivity extends AppCompatActivity {
    int[] btnId = {R.id.btn_0, R.id.btn_0, R.id.btn_1, R.id.btn_2,R.id.btn_3, R.id.btn_4, R.id.btn_5, R.id.btn_6, R.id.btn_7, R.id.btn_8, R.id.btn_9};
